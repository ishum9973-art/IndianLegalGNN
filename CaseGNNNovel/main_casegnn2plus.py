...
def main():   
    ...
    for epoch in tqdm(range(args.epoch)):
        print('Epoch:', epoch)
        forward(args.data, model, device, writer, train_dataloader, train_sumfact_pool_dataset, train_referissue_pool_dataset, train_labels, yf_path, epoch, args.temp, bm25_hard_neg_dict, args.hard_neg_num, args.pos_aug, args.ran_aug, args.aug_edgedrop, args.aug_featmask_node, args.aug_featmask_edge, train_flag=True, embedding_saving=False, optimizer=optimizer, bm25_score_store=train_bm25_score_store)
        with torch.no_grad():            
            ndcg_score_yf = forward(args.data, model, device, writer, test_dataloader, test_sumfact_pool_dataset, test_referissue_pool_dataset, test_labels, yf_path, epoch, args.temp, bm25_hard_neg_dict, args.hard_neg_num, args.pos_aug, args.ran_aug, args.aug_edgedrop, args.aug_featmask_node, args.aug_featmask_edge, train_flag=False, embedding_saving=False, optimizer=optimizer, bm25_score_store=test_bm25_score_store)
    ...
    forward(args.data, model, device, writer, train_dataloader, train_sumfact_pool_dataset, train_referissue_pool_dataset, train_labels, yf_path, epoch, args.temp, bm25_hard_neg_dict, args.hard_neg_num, args.pos_aug, args.ran_aug, args.aug_edgedrop, args.aug_featmask_node, args.aug_featmask_edge, train_flag=True, embedding_saving=True, optimizer=optimizer, bm25_score_store=train_bm25_score_store)
    forward(args.data, model, device, writer, test_dataloader, test_sumfact_pool_dataset, test_referissue_pool_dataset, test_labels, yf_path, epoch, args.temp, bm25_hard_neg_dict, args.hard_neg_num, args.pos_aug, args.ran_aug, args.aug_edgedrop, args.aug_featmask_node, args.aug_featmask_edge, train_flag=False, embedding_saving=True, optimizer=optimizer, bm25_score_store=test_bm25_score_store)
